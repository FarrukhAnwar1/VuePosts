 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YS=5*60,ZS=Dp("authIdTokenMaxAge")||YS;let hd=null;const eC=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>ZS)return;const s=n==null?void 0:n.token;hd!==s&&(hd=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function tC(t=xp()){const e=Pl(t,"auth");if(e.isInitialized())return e.getImmediate();const n=DP(t,{popupRedirectResolver:GS,persistence:[iS,WP,C_]}),r=Dp("authTokenSyncURL");if(r){const i=eC(r);$P(n,i,()=>i(n.currentUser)),BP(n,o=>i(o))}const s=bp("auth");return s&&NP(n,`http://${s}`),n}XS("Browser");const nC=jo({data(){return{mainStore:Xc(),auth:tC(),provider:new Gt}},methods:{handleSignInButtonClick(){uS(this.auth,this.provider)},handleSignOutButtonClick(){qP(this.auth)}},mounted(){jP(this.auth,t=>{this.mainStore.setUser(t),this.mainStore.userLastLogin=new Date,t==null&&(this.mainStore.username="",this.$router.push({name:"posts"}))})}});const rC=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},sC=t=>(Uy("data-v-a1de75dc"),t=t(),By(),t),iC={class:"container-fluid bg-dark navbar-custom sticky-md-top py-2"},oC=sC(()=>ut("div",null,[yr(" Sign In With "),ut("img",{src:"https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg",class:"google-logo"})],-1)),aC=[oC],cC={key:1,class:"container-fluid text-center px-0"},lC={class:"row align-items-center"},uC={class:"col-xs-12 col-md-2"},hC=["src"],fC={class:"col-xs-12 col-md-2 text-break"},dC={class:"col-xs-12 col-md-2"},pC={class:"col-xs-12 col-md-2"},gC={class:"col-xs-12 col-md-2"},mC={class:"col-xs-12 col-md-2"};function _C(t,e,n,r,s,i){const o=ov("router-link");return _s(),zi("div",iC,[t.mainStore.user==null?(_s(),zi("button",{key:0,type:"button",class:"btn btn-dark",onClick:e[0]||(e[0]=a=>t.handleSignInButtonClick())},aC)):(_s(),zi("div",cC,[ut("div",lC,[ut("div",uC,[ut("img",{src:t.mainStore.user.photoURL||""},null,8,hC)]),ut("div",fC,[ut("button",{type:"button",class:"btn btn-dark",onClick:e[1]||(e[1]=a=>t.handleSignOutButtonClick())},"Sign Out")]),ut("div",dC,[De(o,{class:"btn btn-dark",to:{name:"profiles",params:{uid:t.mainStore.user.uid}}},{default:as(()=>[yr("Profile")]),_:1},8,["to"])]),ut("div",pC,[De(o,{class:"btn btn-dark",to:{name:"posts"}},{default:as(()=>[yr("Posts")]),_:1})]),ut("div",gC,[De(o,{class:"btn btn-dark",to:{name:"createPost"}},{default:as(()=>[yr("Create Post")]),_:1})]),ut("div",mC,[De(o,{class:"btn btn-dark",to:{name:"myContent"}},{default:as(()=>[yr("My Content")]),_:1})])])]))])}const yC=rC(nC,[["render",_C],["__scopeId","data-v-a1de75dc"]]),vC=jo({__name:"App",setup(t){return(e,n)=>(_s(),zi(Vt,null,[De(yC),De(Wn(Ip))],64))}});const EC="modulepreload",IC=function(t){return"/VuePosts/"+t},fd={},M_=function(e,n,r){if(!n||n.length===0)return e();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=IC(i),i in fd)return;fd[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!r)for(let u=s.length-1;u>=0;u--){const h=s[u];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":EC,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,h)=>{l.addEventListener("load",u),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e()).catch(i=>{const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i})},$i=()=>M_(()=>import("./PostsView-7602625f.js"),["assets/PostsView-7602625f.js","assets/purify.es-0c4a0514.js","assets/PostsView-b457bf5f.css"]),TC=()=>M_(()=>import("./CreatePostView-7f711976.js"),["assets/CreatePostView-7f711976.js","assets/purify.es-0c4a0514.js","assets/CreatePostView-937a3375.css"]),wC=gI({history:VE("/VuePosts/"),routes:[{path:"/",name:"posts",component:$i,props:{isPersonalPage:!1,isDetailsPage:!1,isProfilePage:!1}},{path:"/create-post",name:"createPost",component:TC,beforeEnter:(t,e)=>Xc().user!=null},{path:"/my-content",name:"myContent",component:$i,props:{isPersonalPage:!0,isDetailsPage:!1,isProfilePage:!1},beforeEnter:(t,e)=>Xc().user!=null},{path:"/posts/:documentId",name:"singlePost",component:$i,props:{isPersonalPage:!1,isDetailsPage:!0,isProfilePage:!1}},{path:"/profiles/:uid",name:"profiles",component:$i,props:{isPersonalPage:!1,isDetailsPage:!1,isProfilePage:!0}}]});var AC="firebase",RC="10.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
